...
last: 
this.month.clone().endOf('month').date() };
...
lastPrevious: 
this.month.clone().subtract(1, 'months').endOf('month').date(),
...
for (let day = this.calendarDays.first; day <= 
this.monthDays.lastPrevious; index++) {
